    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
      ...
      <div className="lg:col-span-2 space-y-4">
        ...
        <CollapsibleSection title="Footer">
          ...
          <Toggle checked={cfg.showGeneratedBy} onChange={v => set('showGeneratedBy', v)} label="Generated by SimpleRx EMR" sub="Footer timestamp"/>
        </CollapsibleSection>
            ...
            <div className="p-3 space-y-2">
              ...
              {(cfg.showSignature || cfg.showGeneratedBy) && (
                <div className="border-t border-slate-100 pt-2 flex justify-between text-[10px]">
                  ...
                  {cfg.showGeneratedBy && <span className="text-slate-300 italic self-end">Generated by SimpleRx EMR</span>}
                </div>
              )}
            </div>
          </div>
