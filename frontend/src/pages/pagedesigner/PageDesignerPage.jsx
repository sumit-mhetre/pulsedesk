    ...
    <div className="flex items-center justify-between py-2.5 border-b border-slate-50 last:border-0">
      ...
      <button type="button" onClick={() => onChange(!checked)}
        ...
        <span className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow transition-transform
          ${checked ? 'translate-x-4.5' : 'translate-x-0.5'}`} style={{transform: checked?'translateX(18px)':'translateX(2px)'}}/>
      </button>
    </div>
  )
}
            ...
            <div className={`bg-white rounded-xl border-2 border-blue-100 overflow-hidden shadow-card
              ...
              <div className="p-3 space-y-2">
                ...
                <div className="border-t border-slate-100 pt-2 flex justify-between items-end">
                  {cfg.showGeneratedBy && <p className="text-slate-300" style={{fontSize:'8px'}}>Generated by PulseDesk</p>}
                  {cfg.showSignature   && (
                    <div className="text-right">
